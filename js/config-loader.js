...
window.parseModesFileImpl = parseModesFileImpl;
window.loadSlotDistributionImpl = loadSlotDistributionImpl;
window.loadTweakDependenciesImpl = loadTweakDependenciesImpl;
window.loadLinksContentImpl = loadLinksContentImpl;
