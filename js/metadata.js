...
window.loadTweakMetadata = loadTweakMetadata;
window.getTweakDisplayName = getTweakDisplayName;
window.getTweakDescription = getTweakDescription;
window.getTweakCategory = getTweakCategory;
window.getTweakAuthor = getTweakAuthor;
